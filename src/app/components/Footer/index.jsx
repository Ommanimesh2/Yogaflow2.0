...
const Footer = ({top, background}) => {
  return (
    <div className='footer' style={{paddingTop:`${top}px`, background: background ? `url(${footerWaves})` : '#FAE6DB' ,backgroundRepeat: "no-repeat",
    backgroundSize: "contain",
    backgroundColor: "#FAE6DB",
}}>
      <div className="footer_primary">
        <div className="footer_title">Vandana.Yogaflow, We're here</div>
        <div className="footer_body">Hello, I am Vandana trying to make an effort to put the right people for you to get the best results. Just insight</div>
      ...
      <div className="footer_secondary">
        <div className="footer_logo">
          <div className="footer_logo_img"><img src={logo} alt="" /></div>
          <div className="footer_logo_title">Yogaflow</div>
        </div>
